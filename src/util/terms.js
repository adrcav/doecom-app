export const privacyPolicy = `
  ...
  <h2>Política de Cookies Doecom</h2>
  ...
  <ul>
      ...
      <li> Cookies relacionados a formulários<br><br> Quando você envia dados por meio de um formulário como os
          encontrados nas páginas de contato ou nos formulários de comentários, os cookies podem ser configurados para
  ...
  <p>Esperemos que esteja esclarecido e, como mencionado anteriormente, se houver algo que você não tem certeza se precisa
      ...
      site.</p>
  <p>Esta política é efetiva a partir de <strong>23 de junho de 2020</strong>.</p>
`;
...
export const termsOfUse = `
  ...
  <p>É concedida permissão para baixar temporariamente uma cópia dos materiais (informações ou software) no site Doecom,
  ...
  <ol>
      ...
      <li>tentar descompilar ou fazer engenharia reversa de qualquer software contido no site Doecom;  </li>
  ...
  <p>Esta licença será automaticamente rescindida se você violar alguma dessas restrições e poderá ser rescindida por
      Doecom a qualquer momento. Ao encerrar a visualização desses materiais ou após o término desta licença, você deve
      apagar todos os materiais baixados em sua posse, seja em formato eletrónico ou impresso.</p>
  <h2>3. Isenção de responsabilidade</h2>
  <ol>
      <li>Os materiais no site da Doecom são fornecidos 'como estão'. Doecom não oferece garantias, expressas ou
      ...
      <li>Além disso, o Doecom não garante ou faz qualquer representação relativa à precisão, aos resultados prováveis
  ...
  <h2>4. Limitações</h2>
  <p>Em nenhum caso o Doecom ou seus fornecedores serão responsáveis ​​por quaisquer danos (incluindo, sem limitação,
      danos por perda de dados ou lucro ou devido a interrupção dos negócios) decorrentes do uso ou da incapacidade de
      usar os materiais em Doecom, mesmo que Doecom ou um representante autorizado da Doecom tenha sido notificado
  ...
  <p>Os materiais exibidos no site da Doecom podem incluir erros técnicos, tipográficos ou fotográficos. Doecom não
      garante que qualquer material em seu site seja preciso, completo ou atual. Doecom pode fazer alterações nos
      materiais contidos em seu site a qualquer momento, sem aviso prévio. No entanto, Doecom não se compromete a
      atualizar os materiais.</p>
  <h2>6. Links</h2>
  <p>O Doecom não analisou todos os sites vinculados ao seu site e não é responsável pelo conteúdo de nenhum site
      vinculado. A inclusão de qualquer link não implica endosso por Doecom do site. O uso de qualquer site vinculado é
      por conta e risco do usuário.</p>
  </p>
  <h3>Modificações</h3>
  <p>O Doecom pode revisar estes termos de serviço do site a qualquer momento, sem aviso prévio. Ao usar este site, você
      concorda em ficar vinculado à versão atual desses termos de serviço.</p>
  <h3>Lei aplicável</h3>
  <p>Estes termos e condições são regidos e interpretados de acordo com as leis do Doecom e você se submete
